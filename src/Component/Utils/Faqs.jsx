  ...
  rows: [
    {
      ...
      content: `Compounding is the process of reinvesting your returns frequently. Reinvesting will increase your capital base, thus you will earn a higher rate of returns compared to if you did not reinvest at all. Auto-compounding uses smart contracts to automate the compounding process. Octafarm maximizes users’ yields by auto-compounding for them multiple times daily.`,
    },
  ],
};
const data3 = {
  ...
  return (
    <div className="fq">
      <div className="container ">
        ...
        <br />
        <Faq data={data6} styles={styles} config={config} /> <br />
        <Faq data={data7} styles={styles} config={config} />
      </div>
    </div>
  );
}
